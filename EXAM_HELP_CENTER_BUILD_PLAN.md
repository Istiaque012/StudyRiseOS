...
| 12 | post-merge: live-route check + indexing | ⬜ todo | — | Gated on PR merge + deploy. Also: confirm help-og.webp present; wire inbound links from /features + /blog/amc-mcq-study-plan (live fetch only); GSC sitemap + request indexing; flip 05 rows to ✅. |
