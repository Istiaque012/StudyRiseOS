...
> This is your operating manual. It explains what this project is, how to set it up once, and the exact things to say to get content researched, written, and ready to publish — plus how to run SEO checks. Keep it short to read; the real depth lives in the nine numbered files.
...
2. **Upload all 10 files** (the nine numbered files + this README) to the project's knowledge.
